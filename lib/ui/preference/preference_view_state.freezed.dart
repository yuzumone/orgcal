...
mixin _$PreferenceViewState implements DiagnosticableTreeMixin {
 ...
 dynamic get viewType; List<String> get urls; List<String> get todoKeywords; List<String> get doneKeywords; int get fontSize; String get timezone;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('viewType', viewType))..add(DiagnosticsProperty('urls', urls))..add(DiagnosticsProperty('todoKeywords', todoKeywords))..add(DiagnosticsProperty('doneKeywords', doneKeywords))..add(DiagnosticsProperty('fontSize', fontSize))..add(DiagnosticsProperty('timezone', timezone));
}
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(viewType),const DeepCollectionEquality().hash(urls),const DeepCollectionEquality().hash(todoKeywords),const DeepCollectionEquality().hash(doneKeywords),fontSize,timezone);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PreferenceViewState(viewType: $viewType, urls: $urls, todoKeywords: $todoKeywords, doneKeywords: $doneKeywords, fontSize: $fontSize, timezone: $timezone)';
}
...
@useResult
$Res call({
 dynamic viewType, List<String> urls, List<String> todoKeywords, List<String> doneKeywords, int fontSize, String timezone
});
...
/// Create a copy of PreferenceViewState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? viewType = freezed,Object? urls = null,Object? todoKeywords = null,Object? doneKeywords = null,Object? fontSize = null,Object? timezone = null,}) {
...
class _PreferenceViewState with DiagnosticableTreeMixin implements PreferenceViewState {
  const _PreferenceViewState({this.viewType = PreferenceViewType.main, final  List<String> urls = const [], final  List<String> todoKeywords = const [], final  List<String> doneKeywords = const [], this.fontSize = 16, this.timezone = 'Asia/Tokyo'}): _urls = urls,_todoKeywords = todoKeywords,_doneKeywords = doneKeywords;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(viewType),const DeepCollectionEquality().hash(_urls),const DeepCollectionEquality().hash(_todoKeywords),const DeepCollectionEquality().hash(_doneKeywords),fontSize,timezone);
...
/// Create a copy of PreferenceViewState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? viewType = freezed,Object? urls = null,Object? todoKeywords = null,Object? doneKeywords = null,Object? fontSize = null,Object? timezone = null,}) {
